...
- `remote-memory-backend-2026-03-17/`: refreshed 2026-03-17 architecture/design snapshot for the remote backend design set.
...
- Exception: `context-engine-split-2026-03-17/` and `remote-memory-backend-2026-03-17/` stay top-level as architecture/design snapshots, but they are not the canonical runtime/source-of-truth docs.
